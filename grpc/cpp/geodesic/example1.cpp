...
int main(int argc, char **argv) 
{
	...
	geodesic::GeodesicAlgorithmSubdivision subdivision_algorithm(&mesh,20);	//with subdivision_level=0 this algorithm becomes Dijkstra, with subdivision_level->infinity it becomes exact
